%% FILE SUMMARY
% Purpose: Compute and visualize avoidance performance with boxplot-style summaries.
...
% Outputs: Comparative distributions of trial-level metrics across selected conditions.
% Run Notes: Use analysisType to switch the analyzed condition file.
...
% plot3(magGT(:,1)*ones(size(angles)),magGT(:,2)+R_avoid*cos(angles),magGT(:,3)+R_avoid*sin(angles),'k--')
hold off
